...
from data import VOCroot, COCOroot, VOC_300, VOC_512, COCO_300, COCO_512, COCO_mobile_300
from data import AnnotationTransform, VOCDetection, detection_collate
from data import COCODetection
from data import BaseTransform, preproc
...
def train():
    ...
    for iteration in range(start_iter, max_iter):
        if iteration % epoch_size == 0: #每达到一个epoch
