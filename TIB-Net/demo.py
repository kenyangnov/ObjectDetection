...
parser.add_argument('--image_dir', type=str, default='./result/img/',
                    help='Directory for detect result')
parser.add_argument('--save_dir', type=str, default='./result/img_det/',
                    help='Directory for detect result')
...
if __name__ == '__main__':
    ...
    net.load_state_dict(torch.load(args.weight)['weight'])
    net.eval()
    if use_cuda:
        net.cuda()
