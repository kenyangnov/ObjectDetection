...
def test_net(save_folder, net, dataset, thresh=0.5):
    ...
    for i in range(num_images):
        ...
        print('im_detect: {:d}/{:d} {:.3f}s'.format(i +
    ...
    with open(det_file_pkl, 'wb') as f:
        ...
        print("detection result has been saved in '.pkl' format.")
    det_file_txt = os.path.join(save_folder, 'result.txt')
    write_voc_results_file(all_boxes, dataset, det_file_txt)
    print("detection result has been saved in '.txt' format.")
...
if __name__ == '__main__':
    ...
    load_folder = os.path.join(args.weight)
    print("load weight file from {}.".format(load_folder))
